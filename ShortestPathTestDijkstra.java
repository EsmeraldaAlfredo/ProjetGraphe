...
public class ShortestPathTestDijkstra {
	...
	/* Retirer les commentaires pour tester les condition sans oracle
	...
	public void testSousCheminToulouse() throws IOException {
		System.out.println("Test de Validité  de Dijkstra  sans Oracle ");
		System.out.println("CAS DE SOUS CHEMIN TOULOUSE");
		//Test en distance
		//String mapName = "/home/commetud/3eme Annee MIC/Graphes-et-Algorithmes/Maps/toulouse.mapgr;
		String mapName = "/home/esmeralda/ProjetGraphe/extras/toulouse.mapgr";
		  // Create a graph reader.
        GraphReader reader = new BinaryGraphReader(
                new DataInputStream(new BufferedInputStream(new FileInputStream(mapName))));
        //done Read the graph.
